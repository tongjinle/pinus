...
Remote.prototype.bind = utils.promisify(function(sid, uid, cb) {
  this.app.get('sessionService').bind(sid, uid, cb);
});

Remote.prototype.unbind = utils.promisify(function(sid, uid, cb) {
  this.app.get('sessionService').unbind(sid, uid, cb);
});

Remote.prototype.push = utils.promisify(function(sid, key, value, cb) {
  this.app.get('sessionService').import(sid, key, value, cb);
});

Remote.prototype.pushAll = utils.promisify(function(sid, settings, cb) {
 ...
 */
Remote.prototype.getBackendSessionBySid = utils.promisify(function(sid, cb) {
 ...
 */
Remote.prototype.getBackendSessionsByUid = utils.promisify(function(uid, cb) {
 ...
 */
Remote.prototype.kickBySid = utils.promisify(function(sid, reason, cb) {
 ...
 * @param  {Function} cb     callback function
 */
Remote.prototype.kickByUid = utils.promisify(function(uid, reason, cb) {
