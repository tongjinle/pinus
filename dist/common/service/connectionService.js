...
class ConnectionService {
    constructor(app) {
         ...
         */
        this.addLoginedUser = function (uid, info) {
            if (!this.logined[uid]) {
                this.loginedCount++;
            }
            info.uid = uid;
         ...
         */
        this.updateUserInfo = function (uid, info) {
         ...
         * @param uid {String} user id
         */
        this.removeLoginedUser = function (uid) {
            if (!!this.logined[uid]) {
                this.loginedCount--;
            }
         ...
         */
        this.decreaseConnectionCount = function (uid) {
            if (this.connCount) {
                this.connCount--;
            }
            if (!!uid) {
         ...
         */
        this.getStatisticsInfo = function () {
            var list = [];
