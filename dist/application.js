...
class Application {
    constructor() {
         ...
         * @memberOf Application
         */
        this.configureLogger = function (logger) {
         ...
         * @memberOf Application
         */
        this.globalFilter = function (filter) {
         ...
         * @memberOf Application
         */
        this.rpcFilter = function (filter) {
         ...
         * @memberOf Application
         */
        this.load = function (name, component, opts) {
         ...
         * @memberOf Application
         */
        this.loadConfigBaseApp = function (key, val, reload) {
            var self = this;
            var env = this.get(Constants.RESERVED.ENV);
         ...
         * @memberOf Application
         */
        this.loadConfig = function (key, val) {
            var env = this.get(Constants.RESERVED.ENV);
            val = require(val);
            if (val[env]) {
                val = val[env];
         ...
         * @memberOf Application
         */
        this.route = function (serverType, routeFunc) {
         ...
         * @memberOf Application
         */
        this.beforeStopHook = function (fun) {
         ...
         * @memberOf Application
         */
        this.set = function (setting, val, attach) {
         ...
         * @memberOf Application
         */
        this.disabled = function (setting) {
            return !this.get(setting);
        };
        /**
         * Enable `setting`.
         ...
         * @memberOf Application
         */
        this.configure = function (env, type, fn) {
         ...
         * @memberOf Application
         */
        this.registerAdmin = function (moduleId, module, opts) {
         ...
         * @memberOf Application
         */
        this.transaction = function (name, conditions, handlers, retry) {
         ...
         * @memberOf Application
         */
        this.getServersFromConfig = function () {
         ...
         * @memberOf Application
         */
        this.getServerById = function (serverId) {
         ...
         * @memberOf Application
         */
        this.getServerFromConfig = function (serverId) {
         ...
         * @memberOf Application
         */
        this.getServersByType = function (serverType) {
         ...
         * @memberOf Application
         */
        this.isFrontend = function (server) {
         ...
         * @memberOf Application
         */
        this.isBackend = function (server) {
            server = server || this.getCurServer();
